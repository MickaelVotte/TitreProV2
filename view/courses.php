                    ...
                    <div class="col-lg-3 col-sm-12 m-0 p-0">
                        <div class="dropdown m-0 p-0">
                            <select class="inputField4" id="type" name="type">
                                <option value="" selected disabled>Veuillez selectionner une catégories</option>
                                <?php foreach ($categoriesType as $value) { ?>
...
<div>
    <div data-aos=fade-up data-aos-offset="200" data-aos-delay="150" data-aos-duration="500" data-aos-easing="ease-in-out" class="row justify-content-md-center m-0 p-3 mt-5 mb-5">
